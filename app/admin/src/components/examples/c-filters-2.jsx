...
import { TypeIcon, HashIcon, ListIcon, TagsIcon, SquareCheckIcon, UserIcon, UsersIcon, MapPinIcon, LayersIcon } from "lucide-react"
...
function toField([label, type, options], copy = 1) {
...
const FIELDS = [...CORE, buildCustomFields()]
