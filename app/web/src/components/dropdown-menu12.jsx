...
export default function Component() {
  ...
  return (
    <div>
      <DropdownMenu>
        <DropdownMenuTrigger
          render={<Button aria-label="Select theme" size="icon" variant="outline" />}>{displayTheme === "light" && <SunIcon aria-hidden="true" size={16} />}{displayTheme === "dark" && <MoonIcon aria-hidden="true" size={16} />}</DropdownMenuTrigger>
