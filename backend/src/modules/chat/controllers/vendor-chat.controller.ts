...
export class VendorChatController {
    ...
    listConversations = asyncHandler(async (req, res) => {
        ...
        const data = await this.conversations.listForActor(userId, "vendor", req.query as never);
    ...
    getConversation = asyncHandler(async (req, res) => {
        const userId = req.actor?.id;
        if (!userId) throw ApiError.unauthorized();
        const data = await this.conversations.getForActor(userId, "vendor", paramId(req));
        res.status(200).json(new ApiResponse(200, data, "ok"));
    });
    ...
    getBookingConversation = asyncHandler(async (req, res) => {
        ...
        const data = await this.conversations.getBookingByOrderId(userId, "vendor", orderId);
        res.status(200).json(new ApiResponse(200, data, "ok"));
    });
    ...
    listMessages = asyncHandler(async (req, res) => {
        const userId = req.actor?.id;
        if (!userId) throw ApiError.unauthorized();
        const data = await this.messages.listMessages(userId, "vendor", paramId(req), req.query as never);
        res.status(200).json(new ApiResponse(200, data, "ok"));
    });
    ...
    presignAttachment = asyncHandler(async (req, res) => {
        const userId = req.actor?.id;
        if (!userId) throw ApiError.unauthorized();
        const data = await this.attachments.presign(userId, "vendor", paramId(req), req.body);
        res.status(200).json(new ApiResponse(200, data, "ok"));
    });
    ...
    completeAttachment = asyncHandler(async (req, res) => {
        ...
        const data = await this.attachments.complete(userId, "vendor", paramId(req), uploadId);
        res.status(200).json(new ApiResponse(200, data, "ok"));
    });
    ...
    sendMessage = asyncHandler(async (req, res) => {
        const userId = req.actor?.id;
        if (!userId) throw ApiError.unauthorized();
        const data = await this.messages.sendMessage(userId, "vendor", paramId(req), req.body);
    ...
    markRead = asyncHandler(async (req, res) => {
        const userId = req.actor?.id;
        if (!userId) throw ApiError.unauthorized();
        await this.messages.markRead(userId, "vendor", paramId(req), req.body.lastReadMessageId);
